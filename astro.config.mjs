...
export default defineConfig({
  ...
  redirects: {
    ...
    "/integrations/amocrm-messengers": "/amocrm/messengers",
    "/automation/amocrm-sales": "/amocrm/sales",
    "/en/integrations/amocrm-messengers": "/amocrm/messengers",
    "/en/automation/amocrm-sales": "/amocrm/sales",
