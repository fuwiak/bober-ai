...
const DIRECT_UI = "https://direct.yandex.ru/dna/grid/campaigns";
const DIRECT_API_REGISTER = "https://yandex.ru/dev/direct/doc/dg/concepts/register.html";
const GALLERY_DOCS = "https://yandex.ru/support/direct/ru/service-gallery/about";
const MASTER_DOCS = "https://yandex.ru/support/direct/ru/campaign-master/service.md";
