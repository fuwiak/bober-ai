        ...
        <article>
          <header className="section-band section--deep border-b border-hairline">
            <div className="container-editorial max-w-4xl">
              <Link href="/blog" className="text-link text-sm">← Все статьи</Link>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {post.tags.map((tag) => (
                  <span key={tag} className="rounded-full border border-hairline px-3 py-1 text-xs text-muted">{tag}</span>
                ))}
              </div>
            </div>
          </header>
