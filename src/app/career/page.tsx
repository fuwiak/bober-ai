...
export const metadata: Metadata = {
  title: "Карьера",
  description:
    "Bober AI Systems ищет селлеров AI-решений: облачные LLM, корпоративные чат-боты, AI-инфраструктура и автоматизация для B2B.",
        ...
        <div className="mb-12 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-on-surface-variant">
              ...
              корпоративными чат-ботами — присоединяйтесь к команде Bober AI Systems.
            </p>
          </div>
          <Link
            href="/"
