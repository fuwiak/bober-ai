    ...
    <LegalPageLayout title="Политика обработки персональных данных" updatedAt={POLICY_UPDATED_AT}>
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-1">
          ...
          <li>
            аналитика посещаемости осуществляется с помощью сервиса «Яндекс.Метрика» (ООО «Яндекс», Российская
            Федерация); счётчик загружается при посещении Сайта. A/B-тестирование через «Varioqub» включается только
            после согласия пользователя во всплывающем уведомлении о cookies;
          </li>
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-1">
          ...
          <li>
            правовое основание обработки: осуществление прав и законных интересов Оператора (п. 7 ч. 1 ст. 6 152-ФЗ)
            — учёт посещаемости и улучшение Сайта;
          </li>
          <li>
          ...
          <li>
            отказ от обработки: удалить cookies в браузере или воспользоваться{" "}
            <a
        ...
        <ul className="mt-3 list-inside list-disc space-y-1">
          <li>оператор сервиса: ООО «Яндекс», Российская Федерация;</li>
          <li>правовое основание: согласие пользователя через всплывающее уведомление о cookies;</li>
          <li>цели использования: проведение экспериментов и A/B-тестов интерфейса Сайта;</li>
          <li>
            скрипт Varioqub загружается только после нажатия «Принять» и не активируется при «Отклонить».
          </li>
        </ul>

        <h3 className="mt-4 font-normal text-ink">7.3. Порядок получения согласия на cookies</h3>
        <p className="mt-3">
          При первом визите Сайт всегда запрашивает согласие через всплывающее уведомление («Принять» или
          «Отклонить»). Скрипт «Яндекс.Метрики» загружается при посещении Сайта и продолжает работать независимо от
          выбранного ответа. Кнопка «Принять» дополнительно включает эксперименты «Varioqub»; при «Отклонить»
          Varioqub не активируется.
        </p>
        <p className="mt-3">
