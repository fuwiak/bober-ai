    ...
    <LegalPageLayout title="Политика обработки персональных данных" updatedAt={POLICY_UPDATED_AT}>
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-1">
          ...
          <li>
            ...
            «Varioqub» (ООО «Яндекс», Российская Федерация); скрипты загружаются при посещении Сайта;
          </li>
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-1">
          <li>оператор сервиса: ООО «Яндекс», Российская Федерация;</li>
          <li>
            правовое основание: осуществление прав и законных интересов Оператора (п. 7 ч. 1 ст. 6 152-ФЗ) —
            улучшение интерфейса Сайта посредством экспериментов;
          </li>
          <li>цели использования: проведение экспериментов и A/B-тестов интерфейса Сайта;</li>
          <li>скрипт Varioqub загружается при посещении Сайта.</li>
        </ul>

        <h3 className="mt-4 font-normal text-ink">7.3. Порядок получения согласия на cookies</h3>
        <p className="mt-3">
          При первом визите Сайт запрашивает согласие через всплывающее уведомление («Принять» или «Отклонить»).
          Скрипты «Яндекс.Метрики» и «Varioqub» загружаются при посещении Сайта и продолжают работать независимо от
          выбранного ответа.
        </p>
        <p className="mt-3">
