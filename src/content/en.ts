const en = {
  ...
  sectionCta: {
    title: "Let's discuss an AI project",
    duration: "30 minutes",
    commitment: "no commitment",
    format: "online",
    cta: "Discuss a project",
    urgency:
      "We will review the task, deployment perimeter and integrations — without pressure or overpromises.",
  },
  claude: {
  ...
  contact: {
    ...
    subtitle:
      "Describe the business task, integrations (1C, Bitrix24, amoCRM), deployment perimeter and data requirements.",
    email: "Email",
    telegram: "Telegram",
    whatsapp: "WhatsApp",
    phone: "Phone",
  ...
  form: {
    intro:
      "Describe the task, systems and perimeter — a preliminary plan and estimate with no commitment.",
    name: "Name",
    company: "Company",
