const en = {
  ...
  hero: {
    ...
    eyebrow: "Bober AI Systems · AI implementation for companies",
    titleLine1: "WE IMPLEMENT AI",
    titleLine2: "AND AUTOMATE PROCESSES",
    valueProposition: "We automate company operations with AI — less manual work, measurable results.",
    differentiator: "We build AI assistants for employees and customers. We connect AI to CRM, ERP, and your systems.",
    benefits: [
      "Faster customer service",
      "Less manual data entry between systems",
      "Automated replies and document processing",
    ...
    implementationAreas: [
      {
        ...
        description: "Commercial proposals in minutes, lead routing, CRM follow-up — measurable pipeline velocity.",
      ...
      {
        badge: "HR",
        title: "AI for HR & onboarding",
        description: "Employee assistants, onboarding portals, policy search — less load on HR and managers.",
      ...
      },
      {
        ...
        description: "Internal AI assistants with RAG over your documents — answers with source citations.",
      ...
      },
      {
        ...
        description: "AI support with escalation, CRM logging, and 24/7 first-line responses.",
      ...
      },
      {
        ...
        description: "OCR, approvals, extraction — documents flow to CRM/ERP without manual re-entry.",
      ...
      },
      {
        ...
        description: "amoCRM, Bitrix24, 1C — bidirectional sync, pipeline automation, zero duplicate entry.",
  ...
  portfolio: {
    title: "Case studies",
    subtitle: "Measurable outcomes — then technology",
