const en = {
  ...
  packages: {
    ...
    items: [
      ...
      },
      {
        ...
        price: "from €3,000",
        duration: "2–4 weeks",
        forWhom: "Validate one scenario on real data before a full rollout",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What is a typical project budget?", a: "Audit from €1,500. Pilot from €3,000. Production implementation from €5,000. We quote fixed scope before development starts." },
