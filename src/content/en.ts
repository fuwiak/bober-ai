const en = {
  meta: {
    title: "Secured corporate AI systems and Kaspersky solutions — Bober AI",
    description:
      "Design and implementation of corporate AI systems, private LLMs, RAG and automation. Authorized Partner of Kaspersky Lab. On-premise and Russian clouds.",
    keywords: [
      "secured corporate AI",
      "authorized Kaspersky partner",
      "Kaspersky for business",
      "corporate AI infrastructure protection",
      "private LLM security",
      "AI systems security",
      "Kaspersky Linux server protection",
  ...
  hero: {
    ...
    titleLine1: "Design and implementation of secured corporate AI systems",
    titleLine2: "",
    valueProposition:
      "Private LLMs, intelligent document processing, RAG, AI analytics and business-process automation with confidentiality, infrastructure and information-security requirements in mind.",
    differentiator: "",
    specialization: "NDA · on-premise · Russian clouds · Kaspersky solutions · Moscow / remote",
    ...
    trustItems: ["NDA", "ON-PREMISE", "RUSSIAN CLOUDS", "KASPERSKY SOLUTIONS"],
    title: "Design and implementation of secured corporate AI systems",
    roles: ["Automation architect", "Production implementation"],
    nameLine: "Pawel Stasinski · '@'pstasinski",
    focus:
      "Authorized Partner of Kaspersky Lab. Design, implementation and integration of secured corporate AI systems.",
    trustLine: "★ {rating} · {reviewCount} reviews · {years} years · 12+ production deployments",
    partnersLine:
      "Authorized Partner of Kaspersky Lab · Business partner of Yandex Cloud, Cloud.ru and Selectel",
    ctaPrimary: "Discuss a secured AI project",
    ctaSecondary: "Estimate architecture and licenses",
  ...
  whyUs: {
    label: "Difference",
    title: "This is not ChatGPT and not a demo",
    text: "We cut manual work, speed up customer responses and reduce operating costs — with measurable payback calculated before kickoff.",
    benefits: [
  ...
  securedAi: {
    label: "Kaspersky · secured AI",
    title: "AI infrastructure with Kaspersky solutions",
    body: [
    ...
    serviceCards: [
      {
        title: "Server and AI infrastructure protection",
        text: "Protection for Linux and Windows servers running corporate applications, databases, RAG systems and private LLMs.",
      },
      {
        title: "Secure cloud and on-premise deployments",
        text: "Design of isolated AI perimeters in the customer’s own infrastructure or Russian clouds.",
      },
      {
        title: "Container environment protection",
        text: "Secure operation design for Docker and Kubernetes applications, image control, access and infrastructure risks.",
      },
      {
        title: "Centralized management",
        text: "Setup of a unified system for protection policies, devices, servers and security events.",
      },
      {
        title: "Integration with corporate systems",
        text: "Connecting AI systems, monitoring and internal processes to Bitrix24, 1C, amoCRM, APIs, databases and internal services.",
      },
      {
        title: "License supply and implementation",
        text: "Official supply of Kaspersky corporate licenses together with setup, integration and support services.",
      },
    ],
    architectureLabel: "Complex project",
    architectureTitle: "Secured corporate AI perimeter, turnkey",
    architectureText:
      "Bober AI owns assessment, architecture, AI components, integrations and go-live. Kaspersky solutions can protect the infrastructure that runs corporate AI.",
    architectureSteps: [
      "Data sources",
      "Secured document intake",
      "OCR and processing",
      "Corporate knowledge base",
      "RAG / private LLM",
      "Integration with 1C, Bitrix24 and internal systems",
      "Server and infrastructure protection with Kaspersky solutions",
      "Monitoring, logging and access control",
    ],
    offeringsLabel: "Services",
    offeringsTitle: "What a secured AI project includes",
    offeringsIntro:
      "Focus — corporate AI systems and infrastructure. Not a classic SOC and not a generalist systems integrator.",
    offerings: [
      "AI infrastructure security audit",
      "secured AI perimeter design",
      "supply of Kaspersky corporate solutions",
      "installation and initial configuration",
      "Linux server protection",
      "private LLM infrastructure protection",
      "monitoring and alerting integration",
      "system support and evolution",
    ],
    projectsLabel: "Scenarios",
    projectsTitle: "Which projects this fits",
    projects: [
      "Private LLM for confidential documents",
      "AI assistant for employees",
      "Intelligent processing of contracts and reports",
      "AI analytics in Bitrix24 and 1C",
      "RAG system inside the internal perimeter",
      "Local AI platform on the customer’s server",
      "Secured infrastructure for an AI product",
      "Corporate automation with limited data access",
    ],
    ctaPrimary: "Discuss a secured AI project",
    ctaSecondary: "Estimate architecture and licenses",
  },
  ...
  sectionCta: {
    title: "Let's discuss a secured AI project",
    duration: "30 minutes",
    commitment: "no commitment",
    format: "online",
    cta: "Discuss a secured AI project",
    urgency:
      "We will review the task, deployment perimeter and whether Kaspersky supply is needed — without pressure or overpromises.",
  },
  claude: {
    ...
    items: [
      {
        ...
        a: "Yes. Bober AI is an Authorized Partner of Kaspersky Lab and can officially supply Kaspersky corporate products.",
      },
      {
        q: "Can Kaspersky be included in an AI implementation project?",
        a: "Yes. Kaspersky solutions can be part of the overall project architecture to protect servers, workplaces, virtual and cloud infrastructure.",
      },
      {
        q: "Do you only implement Kaspersky products?",
        a: "No. Bober AI’s core focus is corporate AI systems, automation and integrations. Kaspersky solutions are used as part of a secured infrastructure stack when the customer needs them.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes, but Bober AI’s main value is solution selection, architecture, implementation, integration and support.",
      },
  ...
  contact: {
    title: "Discuss a secured AI project",
    subtitle:
      "Describe the business task, infrastructure, number of servers and workplaces, and requirements for on-premise, cloud and data protection.",
    email: "Email",
    telegram: "Telegram",
    whatsapp: "WhatsApp",
    phone: "Phone",
  ...
  form: {
    ...
    messagePlaceholder: "What to automate or protect, current perimeter, scale",
    ...
    submit: "Discuss a secured AI project",
    submitting: "Sending…",
    successTitle: "Sent",
