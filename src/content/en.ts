const en = {
  ...
  hero: {
    ...
    founderBadge: "Founder of Bober AI",
    teamLine: "Leads architecture · specialist team for delivery — not a solo freelancer",
    ...
    roles: ["Founder of Bober AI", "AI architect · team for delivery"],
  ...
  whyTrust: {
    ...
    items: [
      "Founder Pawel Stasinski leads architecture and is accountable for outcomes — not a solo freelancer: a specialist team joins for delivery",
  ...
  career: {
    navLabel: "Career",
    metaTitle: "Career — Sales, AI Engineer, MLOps roles",
    metaDescription: "Open roles at Bober AI Systems: Sales / BD for AI projects, AI Engineer and MLOps. Remote, B2B delivery team.",
    label: "Career",
    title: "Open roles at Bober AI",
    lead: "We are hiring for AI project sales and engineering. The founder leads architecture — delivery is built with a specialist team.",
    ...
    roles: [
      ...
      },
      {
        ...
        type: "Remote · project / contract",
        summary: "AI infrastructure and ops: deploy, monitor, cloud / on-prem perimeters, access security.",
        responsibilities: [
          "Deploy inference / RAG stacks in cloud or on-prem",
          "Observability: logs, alerts, quotas, access control",
          "Support handover to the client with the team",
        ],
        requirements: [
          "Docker/K8s or managed cloud for ML/LLM services",
          "Networks, secrets, IAM and logging fluency",
          "Comfortable working inside client closed perimeters",
        ],
        applySubject: "Career — MLOps",
      },
    ],
  },
  footer: {
