const en = {
  meta: {
    ...
    description:
      "Bober AI Systems — AI integration and business process automation: CRM, documents, sales, support. Audit from €1,500, pilot from €3,000, production implementation from €5,000.",
    keywords: [
      "claude ai",
      "claude api",
      "claude code",
  ...
  hero: {
    ...
    eyebrow: "Bober AI Systems · AI integration · Business automation",
    titleLine1: "We cut manual work in sales, documents and CRM by 40–80%",
    titleLine2: "",
    valueProposition:
      "We connect AI to Bitrix24, 1C, amoCRM, email and your corporate data. The system processes requests, prepares documents, updates CRM and helps employees — without manual data re-entry.",
    differentiator: "",
    specialization: "Pilot from €3,000 · production implementation from €5,000 · NDA and your perimeter",
  ...
  sectionCta: {
    title: "30 minutes — we'll review your task",
    duration: "30 minutes",
    commitment: "no obligation",
    format: "online",
    cta: "Schedule a call",
    urgency:
      "I typically run only a few projects at a time. The next window opens after the current implementation completes.",
  },
  claude: {
  ...
  contact: {
    title: "Contact",
    subtitle: "Telegram, WhatsApp, email or the form — we reply within 4 hours.",
    email: "Email",
    telegram: "Telegram",
    whatsapp: "WhatsApp",
    phone: "Phone",
