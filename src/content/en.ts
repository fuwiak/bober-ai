const en = {
  ...
  nav: {
    ...
    servicesDesc: "AI solutions catalog for business tasks",
    secureAiDesc: "Secured perimeter and LLM Security",
    ...
    aboutDesc: "Team and delivery approach",
    careerDesc: "Open roles and work culture",
    partnersDesc: "Partner program",
    blogDesc: "Practice and implementation notes",
    academyDesc: "Hands-on AI workshop for business",
    guidesDesc: "Guides and checklists",
    mediaDesc: "Press and mentions",
    faqDesc: "Common questions about working with us",
    promoTitle: "Need a pilot for your perimeter?",
    promoText: "We'll map the bottleneck and give a fixed estimate.",
    promoCta: "Discuss the task",
    footTagNda: "NDA",
    footTagFixed: "Fixed estimate",
    footTagRu: "Cloud / on-prem / RU",
  ...
  leadMagnets: {
    ...
    subtitle: "Lead magnets next to the ROI calculator — prepare for a project estimate without pressure.",
    items: [
      {
        id: "audit-checklist",
        title: "Checklist: data for an audit",
        description: "What to gather before the meeting: process, systems, volumes, bottlenecks and perimeter requirements.",
        cta: "Get the checklist",
        service: "Audit data checklist",
      },
      {
        id: "assessment",
        title: "30-minute project assessment",
        description: "A short review of the task: budget range, pilot timeline and the next step — no slide deck for its own sake.",
        cta: "Request an assessment",
        service: "30-minute project assessment",
      },
      {
        id: "guide",
        title: "Mini guide: where to start with AI",
        description: "When automation is enough without an LLM, when RAG helps, and how to lock ROI before development.",
        cta: "Open guides",
        href: "/guides",
      },
    ],
  ...
  packages: {
    ...
    auditNote: "The audit fee is credited toward the project budget if we continue to implementation. NDA and your own environment available on request before any data is shared.",
    urgency:
  ...
  whyTrust: {
    ...
    items: [
      "Founder Pawel Stasinski leads architecture and is accountable for outcomes — a specialist team joins for delivery",
  ...
  form: {
    ...
    qualifyLegend: "Before the meeting (optional)",
    qualifyHint: "Short answers help us estimate timeline and budget — skip anytime.",
    processType: "Process type",
    systems: "Systems",
    budget: "Budget",
    timeline: "Timeline",
    processOptions: ["Sales / proposals", "Documents / OCR", "CRM / ERP", "Support", "Knowledge base / RAG", "Other"],
    systemsOptions: ["Bitrix24", "amoCRM", "ERP / 1C", "Excel / email", "Multiple systems", "Our own system"],
    budgetOptions: ["Up to €5,000", "€5,000–€10,000", "€10,000–€20,000", "More than €20,000", "Need an estimate"],
    timelineOptions: ["ASAP", "1–2 months", "This quarter", "Still exploring"],
    optional: "(optional)",
  ...
  career: {
    navLabel: "Career",
    metaTitle: "Career — Sales, AI Engineer, 1C consultant roles",
    metaDescription: "Open roles at Bober AI Systems: Sales / BD for AI projects, AI Engineer and 1C consultant. Remote, B2B delivery team.",
    label: "Career",
    title: "Open roles at Bober AI",
    lead: "We are hiring for AI project sales, engineering and 1C delivery. The founder leads architecture — delivery is built with a specialist team.",
    responsibilitiesLabel: "Responsibilities",
    requirementsLabel: "Requirements",
    applyTelegram: "Apply on Telegram",
    applyEmail: "Send a CV",
    perksLabel: "How we work",
    perksTitle: "What to know before applying",
    perks: [
      { title: "A team, not a solo act", description: "The founder owns architecture; engineers and specialists cover delivery per perimeter." },
      { title: "Real B2B projects", description: "CRM, documents, RAG, private LLMs — production work with measurable ROI." },
      { title: "Simple apply", description: "A short note with your experience on Telegram or email — we reply with role details." },
    ],
    roles: [
      {
        id: "sales",
        ...
        department: "Sales",
        type: "Remote · B2B",
        summary: "Sell and grow AI automation engagements for companies: audit, pilot and production perimeter.",
        responsibilities: [
          "Qualify inbound and outbound leads",
          "Run deals to signature with architect pre-sales support",
          "Prepare proposals from cases and pricing",
        ],
        requirements: [
          "B2B sales experience with complex services or IT",
          "Comfortable speaking business outcomes, not only tech",
          "Self-driven CRM / pipeline discipline",
        ],
        applySubject: "Career — Sales AI",
      },
      {
        id: "ai-engineer",
        title: "AI Engineer",
        department: "Engineering",
        type: "Remote · project / contract",
        summary: "Build AI perimeters: assistants, RAG, agents, CRM/ERP and document integrations.",
        responsibilities: [
          "Design and ship RAG / agent scenarios",
          "Integrate Bitrix24, amoCRM, ERP and client APIs",
          "Quality, logs and acceptance criteria with the architect",
        ],
        requirements: [
          "LLM APIs, embeddings and data pipeline experience",
          "Solid backend (Python/TS) and API work",
          "Production mindset: errors, idempotency, monitoring",
        ],
        applySubject: "Career — AI Engineer",
      },
      {
        id: "1c-consultant",
        title: "1C Consultant",
        department: "1C",
        type: "Remote · project / contract",
        summary: "1C consulting and delivery alongside CRM and automation: data exchange, customizations, client perimeter support.",
        responsibilities: [
          "Analyse client processes and configure / customize 1C solutions",
          "Integrate 1C ↔ CRM (Bitrix24, amoCRM) and related exchange flows",
          "Documentation, user training and handover to the client team",
        ],
        requirements: [
          "Hands-on 1C implementation or support (Trade, ERP, Accounting or industry editions)",
          "Familiar with exchanges, API/COM/HTTP services and typical CRM↔1C scenarios",
          "Comfortable with business stakeholders: requirements, timelines, acceptance criteria",
        ],
        applySubject: "Career — 1C Consultant",
      },
    ],
  },
  footer: {
