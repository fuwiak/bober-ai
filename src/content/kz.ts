...
const kzFaqLead = [
  ...
  },
  {
    ...
    a: "Bitrix24, amoCRM, 1С, WhatsApp, Telegram и внутренние системы. Secure ИИ и закрытый контур — для чувствительных данных.",
  },
  {
...
const kzOverrides = {
  meta: {
    ...
    description:
      "ИИ-интегратор для бизнеса в Казахстане: Bitrix24, amoCRM, 1С, WhatsApp и Telegram. Пилот от 2,5 млн ₸ — облако или закрытый контур, контроль доступа, передача кода. Алматы и Астана.",
    keywords: [
      "интеграция битрикс24 Казахстан",
      "автоматизация CRM Казахстан",
      "внедрение Bitrix24 Алматы",
      "amoCRM Астана",
      "интеграция 1С Казахстан",
      "ИИ для бизнеса Казахстан",
      "корпоративный ИИ-интегратор",
  ...
  pages: {
    pricing: {
      metaTitle: "Цены на ИИ и автоматизацию в Казахстане — Bober AI",
      metaDescription:
  ...
  about: {
    tagline: "ИИ-интегратор для бизнеса в Казахстане",
