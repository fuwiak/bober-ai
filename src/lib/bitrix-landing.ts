...
export const BITRIX_SERVICES_SUMMARY =
  "Настройка Bitrix24, автоматизация документов, автоматизация Bitrix24, интеграция Bitrix24 с 1С, генерация и автоматизация коммерческого предложения, Bitrix24 AI, настройка телефонии Bitrix24, внедрение AI-ассистента, разработка RAG-систем. Плюс внедрение Битрикс24 с ИИ, AI-контур отдела продаж, MCP, локальный LLM. Участие в партнерской программе 1С-Битрикс · ID 28909898.";

/** Контент /bitrix в формате SeoServicePage (как /services/ai-sales-loop). */
export const BITRIX_SEO_CONTENT: SeoServiceContent = {
  metaTitle: "Внедрение и настройка Битрикс24 под ключ — цена и услуги | Bober AI",
  metaDescription:
    "Внедрение и настройка Битрикс24 под ключ: от 150 000 ₽. Интеграция с 1С, ЗУП, документами и телефонией — от 300 000 ₽. ИИ для продаж — от 500 000 ₽. Партнёр 1С-Битрикс ID 28909898.",
  eyebrow: "Услуга · Битрикс24",
  h1: "Внедрение и настройка Битрикс24 под ключ",
  subtitle:
    "Портал, воронка, роли и роботы. Дальше — интеграция с 1С/ЗУП/УНФ, документы и ИИ для отдела продаж. Партнёр 1С-Битрикс · фиксированная смета.",
