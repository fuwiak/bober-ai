...
export const BITRIX_SEO_CONTENT: SeoServiceContent = {
  metaTitle: "Настройка Bitrix24 — автоматизация документов, AI и интеграция с 1С",
  metaDescription:
    "Настройка Bitrix24 от 150 000 ₽ · 1С/документы/телефония от 300 000 ₽ · AI-контур от 500 000 ₽ · партнёр 1С-Битрикс ID 28909898.",
  eyebrow: "Услуга · Битрикс24",
  h1: "Настройка Bitrix24 — автоматизация документов и AI",
  subtitle:
    "Расширяем возможности Bitrix24 AI под реальные процессы компании: 1С, телефония, документы, КП и собственная бизнес-логика. Не конкурируем с BitrixGPT — продаём слой внедрения поверх него.",
