...
export const BITRIX_SEO_CONTENT: SeoServiceContent = {
  ...
  metaDescription:
    "Настройка Bitrix24, автоматизация документов, интеграция с 1С, Bitrix24 AI, телефония и MCP. Пилот от 300 000 ₽ · партнёр 1С-Битрикс ID 28909898.",
  ...
  intro: [
    ...
    `${BITRIX_PARTNER_PROGRAM.line}. Пилот — 2–4 недели, от 300 000 ₽, облако или коробочная версия. NDA и свой контур — стандарт для B2B.`,
  ],
  ...
  roi: [
    { value: "2–4 нед.", label: "пилот на одном процессе" },
    { value: "от 300 000 ₽", label: "бюджет пилота" },
  ...
  faq: [
    ...
    {
      q: "Какие пакеты есть?",
      a: "Внедрение Битрикс24 с AI (от 150 000 ₽), AI-автоматизация, AI-аналитика, AI-контур продаж, интеграции с 1С, MCP и локальный LLM — см. блоки пакетов и услуг ниже на странице.",
    },
    {
    ...
    },
    {
      ...
      a: "Два направления: внешние сервисы → BitrixGPT через MCP Hub и Claude/ChatGPT → действия в Битрикс24 через MCP-сервер в рамках прав сотрудника.",
    },
    {
      q: "Есть ли AI-контур продаж отдельно?",
      a: "Да — /services/ai-sales-loop: телефония, CRM и follow-up в одном продукте. На этой странице — полный контур внедрения Битрикс24 + AI.",
    },
    {
      q: "Бюджет и сроки?",
      a: "Пилот от 300 000 ₽ за 2–4 недели (1 процесс, 1 CRM, до 2 интеграций). Аудит процессов — от 150 000 ₽. Промышленное внедрение — от 500 000 ₽.",
    },
    {
