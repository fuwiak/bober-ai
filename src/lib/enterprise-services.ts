...
const ruExtra: EnterpriseService[] = [
  ...
  { id: "amocrm-pricing", slug: "amocrm-pricing", title: "Сколько стоит внедрение amoCRM", description: "Цена настройки и внедрения amoCRM — понятные пакеты и смета до старта.", about: "Ориентиры бюджета на настройку, внедрение и ИИ-слой для amoCRM.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm-pricing", inServicesCatalog: false, omitFeedPicture: true },
  { id: "amocrm-ai-agent", slug: "amocrm-ai-agent", title: "ИИ-агент для amoCRM", description: "ИИ-агент в amoCRM: квалификация, задачи и дожим в карточке сделки.", about: "Агент с действиями в amoCRM и human-in-the-loop.", salesNotes: "от 500 000 ₽", deliveryDays: 28, price: 500000, serviceImage: IMAGES["ai-agent"], feedPath: "/integrations/amocrm-ai-agent", inServicesCatalog: false, omitFeedPicture: true },
  // Yandex Услуги «amoCRM» intent titles 2026-08-05 — feed-only; YML: no picture; URL → closest landing.
  { id: "amocrm-nastroit", slug: "amocrm-nastroit", title: "Настроить amoCRM", description: "Настроить amoCRM: воронка, поля, роботы, заявки с сайта и мессенджеров.", about: "Настройка amoCRM под ваш процесс продаж — фиксированная смета.", salesNotes: "от 150 000 ₽", deliveryDays: 21, price: 150000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true },
  { id: "amocrm-dorabotka", slug: "amocrm-dorabotka", title: "Доработка amoCRM", description: "Доработка amoCRM: воронки, виджеты, API, отчёты и устранение узких мест.", about: "Точечная доработка портала amoCRM со сметой до старта.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true },
  ...
  { id: "amocrm-integraciya", slug: "amocrm-integraciya", title: "Интеграция amoCRM", description: "Интеграция amoCRM с сайтом, 1С, телефонией, WhatsApp и Telegram.", about: "Двусторонний обмен и вебхуки — логирование и retry.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true },
  { id: "amocrm-konsultaciya", slug: "amocrm-konsultaciya", title: "Консультация amoCRM", description: "Консультация amoCRM: аудит воронки, приоритеты и смета пилота до закупки.", about: "Разбор текущего портала и дорожная карта до внедрения.", salesNotes: "от 50 000 ₽", deliveryDays: 7, price: 50000, serviceImage: IMAGES["ai-consulting"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true },
  ...
  { id: "amocrm-integrator", slug: "amocrm-integrator", title: "Интегратор amoCRM", description: "Интегратор amoCRM: настройка, доработка, API и связка с учётными системами.", about: "Партнёрский контур amoCRM — смета до старта работ.", salesNotes: "от 150 000 ₽", deliveryDays: 21, price: 150000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true },
  ...
  { id: "ii-prodavets", slug: "ii-prodavets", title: "ИИ-продавец", description: "ИИ-продавец: квалификация лидов, дожим и черновики КП в CRM.", about: "Агент продаж с действиями в CRM и эскалацией к менеджеру.", salesNotes: "от 500 000 ₽", deliveryDays: 28, price: 500000, serviceImage: IMAGES["sales-ai-agent"], feedPath: "/services/sales-ai-agent", inServicesCatalog: false, omitFeedPicture: true },
  ...
  { id: "erp-moysklad", slug: "erp-moysklad", title: "Внедрение ERP МойСклад", description: "Внедрение ERP МойСклад: склад, учёт, CRM и ChatGPT-like UX со сметой.", about: "Настройка МойСклад, интеграции и ИИ-чат к остаткам и заказам.", salesNotes: "от 300 000 ₽", deliveryDays: 28, price: 300000, serviceImage: IMAGES["erp-moysklad"], feedPath: "/solutions/erp-moysklad", inServicesCatalog: false, omitFeedPicture: true },
