...
const ruExtra: EnterpriseService[] = [
  ...
  { id: "company-automation", slug: "company-automation", title: "Компания по автоматизации бизнеса", description: "Процессы, CRM, документы и отчёты без ручного копирования — фиксированная смета и ROI.", about: "Аудит узкого места, workflow и интеграции, промышленный запуск и обучение команды.", salesNotes: "от 500 000 ₽", deliveryDays: 21, price: 500000, serviceImage: IMAGES["company-automation"], feedPath: "/automation/company-automation", inServicesCatalog: false },
  ...
  { id: "amocrm-konsultaciya", slug: "amocrm-konsultaciya", title: "Консультация amoCRM", description: "Консультация amoCRM: аудит воронки, приоритеты и смета пилота до закупки.", about: "Разбор текущего портала и дорожная карта до внедрения.", salesNotes: "от 150 000 ₽", deliveryDays: 7, price: 150000, serviceImage: IMAGES["ai-consulting"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedPicture: true, omitFromFeed: true },
  ...
  { id: "amocrm-integrator", slug: "amocrm-integrator", title: "Интегратор amoCRM", description: "Интегратор amoCRM: настройка, доработка, API и связка с учётными системами.", about: "Партнёрский контур amoCRM — смета до старта работ.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: "/stock/offers/land-integrations-amocrm-integrator.jpg", feedPath: "/integrations/amocrm-integrator", inServicesCatalog: false },
  { id: "bitrix24-integrator", slug: "bitrix24-integrator", title: "Интегратор Битрикс24", description: "Интегратор Битрикс24: сайт, 1С, телефония, мессенджеры — с логом и приёмкой.", about: "Чиним обмен или собираем новый контур. Бизнес-партнёр Битрикс24.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: "/stock/offers/land-integrations-bitrix24-integrator.jpg", feedPath: "/integrations/bitrix24-integrator", inServicesCatalog: false },
  { id: "llm-dlya-1c", slug: "llm-dlya-1c", title: "LLM для 1С", description: "LLM для 1С: ответы по справочникам и черновики документов без утечки во внешние чаты.", about: "Приватный контур LLM над разрешёнными данными 1С.", salesNotes: "от 400 000 ₽", deliveryDays: 28, price: 400000, serviceImage: "/stock/offers/land-ai-llm-dlya-1c.jpg", feedPath: "/ai/llm-dlya-1c", inServicesCatalog: false },
  { id: "integraciya-ii-s-crm", slug: "integraciya-ii-s-crm", title: "Интеграция ИИ с CRM", description: "Интеграция ИИ с CRM: ассистент в сделке, задачи и дожим на одной воронке.", about: "ИИ-слой поверх Bitrix24 / amoCRM с human-in-the-loop.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: "/stock/offers/land-integrations-integraciya-ii-s-crm.jpg", feedPath: "/integrations/integraciya-ii-s-crm", inServicesCatalog: false },
  { id: "alisa-ai", slug: "alisa-ai", title: "Интеграция Алиса ИИ", description: "Алиса ИИ: навыки, диалог и действия в CRM/сайте — запись, статус, FAQ.", about: "Разработка навыка Алисы и связка с Bitrix24 / amoCRM / API. Фиксированная смета.", salesNotes: "от 300 000 ₽", deliveryDays: 28, price: 300000, serviceImage: "/stock/offers/land-integrations-alisa-ai.jpg", feedPath: "/integrations/alisa-ai", inServicesCatalog: true },
  { id: "vnedrenie-ii-v-biznes-processy", slug: "vnedrenie-ii-v-biznes-processy", title: "Внедрение ИИ в бизнес-процессы", description: "Внедрение ИИ в бизнес-процессы: один процесс с KPI и сметой до кода.", about: "Пилот в промышленной эксплуатации с передачей команде.", salesNotes: "от 400 000 ₽", deliveryDays: 28, price: 400000, serviceImage: "/stock/offers/land-ai-vnedrenie-ii-v-biznes-processy.jpg", feedPath: "/ai/vnedrenie-ii-v-biznes-processy", inServicesCatalog: false },
  { id: "integrator-iskusstvennogo-intellekta", slug: "integrator-iskusstvennogo-intellekta", title: "Интегратор искусственного интеллекта", description: "Интегратор ИИ: внедрение в процессы компании, не демо-чат.", about: "Смета, KPI и handover — industrial contour.", salesNotes: "от 400 000 ₽", deliveryDays: 28, price: 400000, serviceImage: "/stock/offers/land-ai-integrator-ii.jpg", feedPath: "/ai/integrator-iskusstvennogo-intellekta", inServicesCatalog: false },
