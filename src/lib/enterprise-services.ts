...
const ruExtra: EnterpriseService[] = [
  ...
  // Yandex Услуги «amoCRM» intent titles 2026-08-05 — feed-only; YML: no picture, no page URL.
  { id: "amocrm-nastroit", slug: "amocrm-nastroit", title: "Настроить amoCRM", description: "Настроить amoCRM: воронка, поля, роботы, заявки с сайта и мессенджеров.", about: "Настройка amoCRM под ваш процесс продаж — фиксированная смета.", salesNotes: "от 150 000 ₽", deliveryDays: 21, price: 150000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-dorabotka", slug: "amocrm-dorabotka", title: "Доработка amoCRM", description: "Доработка amoCRM: воронки, виджеты, API, отчёты и устранение узких мест.", about: "Точечная доработка портала amoCRM со сметой до старта.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-vnedrit", slug: "amocrm-vnedrit", title: "Внедрить amoCRM", description: "Внедрить amoCRM под ключ: воронка, интеграции, регламенты и приёмка.", about: "Внедрение amoCRM с сметой, сроками и промышленным контуром.", salesNotes: "от 300 000 ₽", deliveryDays: 28, price: 300000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-integraciya", slug: "amocrm-integraciya", title: "Интеграция amoCRM", description: "Интеграция amoCRM с сайтом, 1С, телефонией, WhatsApp и Telegram.", about: "Двусторонний обмен и вебхуки — логирование и retry.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/amocrm", inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-konsultaciya", slug: "amocrm-konsultaciya", title: "Консультация amoCRM", description: "Консультация amoCRM: аудит воронки, приоритеты и смета пилота до закупки.", about: "Разбор текущего портала и дорожная карта до внедрения.", salesNotes: "от 50 000 ₽", deliveryDays: 7, price: 50000, serviceImage: IMAGES["ai-consulting"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-pod-klyuch", slug: "amocrm-pod-klyuch", title: "amoCRM под ключ", description: "amoCRM под ключ: настройка, внедрение, интеграции и обучение команды.", about: "Полный контур amoCRM со сметой и приёмкой.", salesNotes: "от 300 000 ₽", deliveryDays: 28, price: 300000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-integrator", slug: "amocrm-integrator", title: "Интегратор amoCRM", description: "Интегратор amoCRM: настройка, доработка, API и связка с учётными системами.", about: "Партнёрский контур amoCRM — смета до старта работ.", salesNotes: "от 150 000 ₽", deliveryDays: 21, price: 150000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-avtomatizaciya", slug: "amocrm-avtomatizaciya", title: "Автоматизация amoCRM", description: "Автоматизация amoCRM: роботы, триггеры, задачи и дожим без ручного копирования.", about: "Автоматизация воронки amoCRM — фиксированная смета.", salesNotes: "от 150 000 ₽", deliveryDays: 21, price: 150000, serviceImage: IMAGES["crm-automation"], feedPath: "/integrations/amocrm-automation", inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-voronka-setup", slug: "amocrm-voronka-setup", title: "Настройка воронки amoCRM", description: "Настройка воронки amoCRM: стадии, поля, права и контроль конверсии.", about: "Рабочая воронка продаж в amoCRM под ваш регламент.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "amocrm-audit", slug: "amocrm-audit", title: "Аудит amoCRM", description: "Аудит amoCRM: карта потерь в воронке, приоритеты и смета доработок.", about: "Аудит портала amoCRM с ROI и планом на 90 дней.", salesNotes: "от 50 000 ₽", deliveryDays: 7, price: 50000, serviceImage: IMAGES["business-process-audit"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  ...
  { id: "ii-chatboty-pod-klyuch", slug: "ii-chatboty-pod-klyuch", title: "Разработка чат-ботов под ключ для бизнеса", description: "Разработка чат-ботов под ключ для бизнеса: квалификация, FAQ, заявки в CRM.", about: "Чат-бот под процесс продаж/поддержки со сметой и приёмкой.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["enterprise-ai-assistant"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "ii-integraciya", slug: "ii-integraciya", title: "Интеграция ИИ в CRM", description: "Интеграция ИИ в CRM: ассистент в карточке, скоринг, саммари и задачи.", about: "ИИ-слой поверх Bitrix24/amoCRM без смены воронки.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["ai-for-crm"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "ii-neyronnye-seti", slug: "ii-neyronnye-seti", title: "Разработка нейронных сетей для бизнеса", description: "Разработка нейронных сетей для бизнеса: LLM, RAG и агенты под ваши данные.", about: "Приватный LLM-контур, база знаний и интеграции с учётными системами.", salesNotes: "от 500 000 ₽", deliveryDays: 28, price: 500000, serviceImage: IMAGES["llm-development"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "ii-agenty-vnedrenie", slug: "ii-agenty-vnedrenie", title: "Внедрение ИИ-агентов", description: "Внедрение ИИ-агентов: действия в CRM, документах и workflow с контролем.", about: "Многошаговые агенты с инструментами, аудитом и эскалацией к человеку.", salesNotes: "от 500 000 ₽", deliveryDays: 28, price: 500000, serviceImage: IMAGES["ai-agent"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  // Yandex Услуги «ERP МойСклад» 2026-08-05 — feed-only title variants; YML: no picture, no page URL.
  { id: "erp-moysklad", slug: "erp-moysklad", title: "Внедрение ERP МойСклад", description: "Внедрение ERP МойСклад: склад, учёт, CRM и ChatGPT-like UX со сметой.", about: "Настройка МойСклад, интеграции и ИИ-чат к остаткам и заказам.", salesNotes: "от 300 000 ₽", deliveryDays: 28, price: 300000, serviceImage: IMAGES["erp-moysklad"], feedPath: "/solutions/erp-moysklad", inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-setup", slug: "moysklad-setup", title: "Настройка МойСклад", description: "Настройка МойСклад: склады, номенклатура, резервы и статусы заказов.", about: "Настройка ERP МойСклад под складской учёт — фиксированная смета.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["erp-moysklad"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-crm-integration", slug: "moysklad-crm-integration", title: "Интеграция МойСклад с CRM", description: "Интеграция МойСклад с Bitrix24 / amoCRM: остатки, заказы, задачи.", about: "Двусторонний обмен МойСклад ↔ CRM с логированием и retry.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-automation", slug: "moysklad-automation", title: "Автоматизация МойСклад", description: "Автоматизация МойСклад: резервы, отгрузки, алерты и задачи без ручного копирования.", about: "Workflow поверх МойСклад и CRM — смета до старта.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["business-process-automation"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-pod-klyuch", slug: "moysklad-pod-klyuch", title: "МойСклад под ключ", description: "МойСклад под ключ: внедрение, интеграции, обучение и приёмка.", about: "Полный контур ERP МойСклад со сметой и сроками.", salesNotes: "от 500 000 ₽", deliveryDays: 28, price: 500000, serviceImage: IMAGES["erp-moysklad"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-pricing", slug: "moysklad-pricing", title: "Сколько стоит внедрение МойСклад", description: "Цена настройки и внедрения МойСклад — понятные пакеты и смета до старта.", about: "Ориентиры бюджета на МойСклад, интеграции и ИИ-чат.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["erp-moysklad"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-ai", slug: "moysklad-ai", title: "ИИ для МойСклад", description: "ИИ для МойСклад: чат к остаткам, заказам и отгрузкам с действиями в ERP.", about: "LLM + tools к API МойСклад — не пилот на публичном ChatGPT.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["enterprise-ai-assistant"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-chatgpt-ux", slug: "moysklad-chatgpt-ux", title: "ChatGPT UX для МойСклад", description: "ChatGPT-like UX для МойСклад: диалог со складом и учётом в вашем контуре.", about: "Привычный чат-интерфейс с доступом к ERP и CRM.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["enterprise-ai-assistant"], feedPath: "/solutions/erp-moysklad", inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-crm-sync", slug: "moysklad-crm-sync", title: "Интеграция CRM и МойСклад", description: "Интеграция CRM и МойСклад: сделки видят резервы, склад — статусы продаж.", about: "Единый контур CRM ↔ ERP без ручного переноса.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["crm-integration"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  { id: "moysklad-warehouse", slug: "moysklad-warehouse", title: "Внедрение склада МойСклад", description: "Внедрение склада и учёта в МойСклад: номенклатура, резервы, отгрузки.", about: "Складской контур МойСклад под ваш процесс — смета и приёмка.", salesNotes: "от 300 000 ₽", deliveryDays: 21, price: 300000, serviceImage: IMAGES["erp-moysklad"], inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
  // Yandex Услуги «Настройка YClients / amoCRM / Bitrix24 / МойСклад» 2026-08-05 — feed-only; YML: no picture, no page URL.
  ...
  { id: "yclients-setup", slug: "yclients-setup", title: "Настройка YClients", description: "Настройка YClients: онлайн-запись, услуги, сотрудники и уведомления.", about: "Настройка YClients под запись клиентов — фиксированная смета.", salesNotes: "от 150 000 ₽", deliveryDays: 14, price: 150000, serviceImage: IMAGES["crm-integration"], feedPath: "/integrations/crm-setup", inServicesCatalog: false, omitFeedUrl: true, omitFeedPicture: true },
