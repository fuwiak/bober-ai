...
const GUIDES_RU: Record<string, GuideContent> = {
  automateSales: {
    ...
    metaDescription:
      "Как автоматизировать отдел продаж: лиды, CRM, коммерческие предложения, дожим. Практический гайд без buzzword.",
    h1: "Как автоматизировать отдел продаж",
    subtitle: "Пошаговый подход: от карты процесса до промышленного запуска — без «ещё одного SaaS».",
    sections: [
      {
        title: "Шаг 1. Найдите узкое место",
        paragraphs: [
          "Не автоматизируйте всё сразу. Выберите один процесс с максимальной болью: подготовка КП (45 минут на документ), потерянные лиды, ручной дожим или дублирование данных между CRM и Excel.",
      ...
      },
      {
        ...
        paragraphs: [
          "Автоматизация продаж работает, когда CRM — единственное место правды. Лид с сайта → сделка за секунды. Стадии меняются автоматически. Задачи на дожим создаются роботом, а не «когда вспомнят».",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "ИИ нужен не всегда. Шаблоны и правила дают 90% эффекта. LLM — для нестандартных формулировок и подбора позиций из большого каталога.",
        ],
      },
      {
        title: "Шаг 4. дожим и аналитика",
        paragraphs: [
    ...
    checklist: [
      ...
      "дожим по расписанию, не «когда вспомнят»",
  ...
  speedUpProposals: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Опционально: ИИ-слой для сборки текста и подбора позиций из диалога «нужно 500 штук модели X».",
        ],
      },
      {
        title: "Результат на практике",
        paragraphs: [
          "Кейс ELIA Suite: 45 минут → 2 минуты, +32% конверсия КП→заказ. Кейс KP-LLM: цены только из каталога, таблица, НДС, скачивание DOCX/PDF одним кликом.",
    ...
    ctaTitle: "Такой же результат для вашего бизнеса",
  ...
  whenAiMakesSense: {
    metaTitle: "Когда ИИ имеет смысл, а когда достаточно workflow",
    metaDescription:
      "Когда внедрять ИИ в бизнес, а когда хватит CRM и автоматизации без LLM. Практический гайд для CEO и IT.",
    h1: "Когда ИИ имеет смысл, а когда достаточно workflow",
    subtitle: "Технология выбирается в конце — после карты процесса и ROI.",
    sections: [
      {
        title: "Workflow без ИИ",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Условие: есть структурированные данные и процесс. ИИ без CRM и документов — пилот, который не масштабируется.",
        ],
      },
      {
        title: "Как принять решение",
        paragraphs: [
          "Аудит: посчитайте стоимость ручного труда в часах × ставка. Сравните сценарий «только workflow» и «workflow + AI». ИИ добавляет 20–40% к бюджету и требует MLOps.",
          "Начните с workflow. Добавьте ИИ на узком участке с измеримым ROI — поддержка L1, поиск в документах, сборка КП из диалога.",
        ],
      },
      {
    ...
    checklist: [
      ...
      "ROI workflow и workflow+ИИ в одной таблице",
      "Пилот на одном участке, не «ИИ на всю компанию»",
      "Данные в периметре для корпоративных сценариев",
    ],
    ctaTitle: "AI & Automation Audit",
    ctaText: "Проведём аудит, посчитаем ROI по сценариям и скажем честно — нужен ли ИИ или хватит workflow.",
  },
  aiGlossary: {
    metaTitle: "Глоссарий ИИ для бизнеса — RAG, агенты, MCP, Claude, AEO, GEO",
    metaDescription:
      "Словарь терминов enterprise ИИ: LLM, RAG, ИИ-агенты, MCP, Claude API, Claude Code, on-premise, SEO/AEO/GEO — для закупки и IT.",
    h1: "Глоссарий ИИ для бизнеса",
    subtitle: "Ключевые термины enterprise ИИ — без маркетингового шума. Включая популярные запросы про Claude, AEO и GEO.",
    sections: [
      {
      ...
      {
        title: "SEO, AEO, GEO и ИИ SEO — в чём разница",
        paragraphs: [
          "SEO отвечает на вопрос «как поднять сайт в выдаче Яндекса или Google» — результат: позиция в выдаче и клик по ссылке.",
          "AEO (Answer Engine Optimization) — подготовка контента так, чтобы поисковик или ассистент мог сразу вытащить короткий точный ответ: цена, диапазон, факторы, FAQ. Раньше это были featured snippets и голосовой поиск, сейчас — ещё и ответы ИИ.",
          "GEO (Generative Engine Optimization) — цель шире: чтобы ИИ-система не просто ответила, а упомянула, порекомендовала или процитировала компанию в сгенерированном ответе (ChatGPT, Perplexity, Google ИИ Overviews, YandexGPT).",
          "ИИ SEO / AISEO — самый неточный термин: либо использование ИИ для классического SEO (генерация текстов, анализ фраз), либо оптимизация под AI-поиск в целом. Границы между AEO, GEO и ИИ SEO пока не устоялись — даже Google описывает их как часть SEO, а не отдельную дисциплину.",
        ],
      },
      {
        title: "Как мы применяем AEO и GEO на этом сайте",
        paragraphs: [
          "Ключевые страницы построены по схеме: вопрос клиента → короткий прямой ответ → детали → пример → цифры → автор/эксперт → источники → FAQ — так ответ быстро находят и человек, и ИИ-ассистент.",
      ...
      {
        title: "Claude ИИ — что это и зачем бизнесу?",
        paragraphs: [
          "Claude ИИ — нейросеть от Anthropic для текста, документов, кода и многошаговых задач. В бизнесе её используют не как чат, а как движок автоматизации: генерация КП, ответы поддержки, извлечение данных из документов, обновление CRM.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Claude в России ищут чаще всего из‑за доступа к сайту и API. Для компаний проектируют рабочий контур: прокси, корпоративные ключи, on-premise или гибрид с YandexGPT/GigaChat там, где это требует compliance. Данные — в контуре клиента.",
        ],
      },
      {
    ...
    ctaText: "Проведём ИИ & Automation Audit и переведём термины в конкретный план внедрения.",
  },
};
...
export const GUIDE_LABELS = {
  ru: {
    ...
    guidesSubtitle: "Как автоматизировать, как связать системы, когда ИИ имеет смысл — без buzzword.",
  },
  en: {
