...
const EXTENDED_RU: Record<string, LandingExtendedContent> = {
  ...
  documents: {
    intro: [
      ...
      "AI и OCR нужны не всегда: часто хватает маршрутов, статусов и связки с уже купленным ЭДО.",
    ...
    faq: [
      ...
      { q: "AI или OCR?", a: "OCR + правила — для структурированной первички. AI — для нестандартных текстов и классификации." },
  ...
  bitrix24: {
    intro: [
      ...
      "Расширяем возможности Bitrix24 AI под реальные процессы: 1С, телефония, документы, коммерческие предложения и собственная бизнес-логика — поверх нативного агента CRM, а не вместо него.",
      "AI-контур отдела продаж: звонки, переписки, CRM и автоматические следующие действия — один продукт. Не продаём отдельно чат-бота, анализ звонков и интеграцию CRM.",
    ...
    howWeSolve: [
      ...
      {
        title: "AI-слой поверх BitrixGPT",
        text: "Квалификация, саммари, follow-up, действия вне портала (1С, КП, отчёты) — не конкурируем со штатным агентом CRM.",
      },
    ],
    roiTitle: "Результат",
    roi: [
      { value: "1 контур", label: "телефония + чаты + CRM + follow-up" },
      { value: "−30–50%", label: "ручного ввода после звонка" },
      { value: "2–4 нед.", label: "пилот AI-контура на одном канале" },
    ],
