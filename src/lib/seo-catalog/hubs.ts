...
export const SEO_HUBS: HubDef[] = [
  {
    ...
    children: [
      ...
      {
        href: "/automation/company-automation",
        labelRu: "Автоматизация компании",
        labelEn: "Company automation",
        blurbRu: "Процессы, CRM и документы end-to-end.",
        blurbEn: "Processes, CRM and documents end-to-end.",
      },
      {
        href: "/ai/ai-implementation",
        labelRu: "Внедрение ИИ в бизнес",
        labelEn: "AI implementation",
        blurbRu: "Пилот с KPI и production-контур.",
        blurbEn: "KPI pilot and production delivery.",
      },
      {
        href: "/automation/document-ai",
        labelRu: "ИИ для документов",
        labelEn: "AI for documents",
        blurbRu: "Обработка PDF и сканов в CRM/1С.",
        blurbEn: "PDF/scan processing into CRM/ERP.",
      },
      {
        href: "/automation/business-process-audit",
        labelRu: "Аудит процессов",
        labelEn: "Process audit",
        blurbRu: "Карта потерь и смета пилота.",
        blurbEn: "Loss map and pilot estimate.",
      },
    ],
    ru: {
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/integrations/crm-automation", labelRu: "Автоматизация CRM", labelEn: "CRM automation", blurbRu: "Роботы, заявки, воронка", blurbEn: "Robots, intake, pipeline" },
      { href: "/integrations/crm-automation-system", labelRu: "Система автоматизации CRM", labelEn: "CRM automation system", blurbRu: "Комплексный контур", blurbEn: "Full automation contour" },
      { href: "/integrations/crm-process-automation", labelRu: "CRM и процессы", labelEn: "CRM processes", blurbRu: "Процессы в воронке", blurbEn: "Processes in the pipeline" },
      ...
      { href: "/integrations/crm-marketing-automation", labelRu: "CRM и маркетинг", labelEn: "CRM marketing", blurbRu: "Лиды и UTM", blurbEn: "Leads and UTMs" },
      ...
      { href: "/integrations/ai-for-crm", labelRu: "ИИ для CRM", labelEn: "AI for CRM", blurbRu: "Ассистент в карточке сделки", blurbEn: "In-deal AI assistant" },
