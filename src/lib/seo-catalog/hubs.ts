...
export const SEO_HUBS: HubDef[] = [
  {
    ...
    ru: {
      metaTitle: "Автоматизация бизнес-процессов — внедрение и услуги | Bober AI",
      metaDescription:
        "Внедрение Битрикс24, распознавание документов в 1С, интеграции CRM↔1С, речевая аналитика и внедрение ИИ под ключ. Фиксированная смета.",
      h1: "Автоматизация бизнес-процессов и внедрение ИИ",
      subtitle:
        "Битрикс24, 1С, документы, звонки и продажи — от аудита до production с фиксированной сметой.",
      intro: [
        "Рынок ищет внедрение и настройку конкретных систем — не абстрактный «AI-контур».",
        "Клиенты ищут внедрение, цену и под ключ по процессу: CRM, документы, 1С, продажи.",
      ],
    },
    en: {
