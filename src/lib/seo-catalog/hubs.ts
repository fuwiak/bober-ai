...
export const SEO_HUBS: HubDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/integrations/yougile", labelRu: "YouGile", labelEn: "YouGile", blurbRu: "Корпоративный мессенджер · гости по ссылке · от 80 000 ₽", blurbEn: "Corporate messenger · guests by link" },
