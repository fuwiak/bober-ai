...
export const SEO_HUBS: HubDef[] = [
  {
    ...
    children: [
      {
        href: "/automation/avtomatizaciya-sklada",
        labelRu: "Автоматизация склада",
        labelEn: "Warehouse automation",
        blurbRu: "Адресное хранение, ТСД, 1С/МойСклад.",
        blurbEn: "Bin locations, scanners, 1C/MoySklad.",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        blurbRu: "CMS: модули, права, формы · от 150 000 ₽",
      ...
      { href: "/integrations/nastrojka-crm", labelRu: "Настройка CRM", labelEn: "CRM setup", blurbRu: "Воронка, поля, отдел продаж — от 150 000 ₽", blurbEn: "Pipeline, fields, sales team — from a mid-market package" },
      { href: "/integrations/nastrojka-crm-pod-klyuch", labelRu: "Настройка CRM под ключ", labelEn: "Turnkey CRM setup", blurbRu: "Аудит, интеграции, обучение", blurbEn: "Audit, integrations, training" },
      { href: "/integrations/nastrojka-crm-otdel-prodazh", labelRu: "CRM для отдела продаж", labelEn: "CRM for sales", blurbRu: "Стадии, SLA, контроль менеджеров", blurbEn: "Stages, SLA, manager control" },
      ...
      { href: "/integrations/integraciya-1s-s-sajtom", labelRu: "Интеграция 1С с сайтом", labelEn: "1C to website integration", blurbRu: "Товары, остатки, заказы · от 60 000 ₽", blurbEn: "Products, stock, orders" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/solutions/ii-bot-dlya-biznesa", labelRu: "ИИ-бот для бизнеса", labelEn: "AI bot for business", blurbRu: "По вашей базе · в CRM · от 250 000 ₽", blurbEn: "On your base, into CRM" },
      { href: "/solutions/it-konsalting", labelRu: "IT-консалтинг", labelEn: "IT consulting", blurbRu: "Аудит, ИТ-стратегия, план с бюджетом", blurbEn: "Audit, strategy, roadmap" },
      { href: "/solutions/cifrovizaciya-biznesa", labelRu: "Цифровизация бизнеса", labelEn: "Business digitalisation", blurbRu: "От Excel к связанным CRM, 1С и ИИ", blurbEn: "From Excel to connected systems" },
      { href: "/solutions/migraciya-v-oblako", labelRu: "Миграция в облако", labelEn: "Cloud migration", blurbRu: "Yandex Cloud, Selectel, Cloud.ru", blurbEn: "Russian cloud partners" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/ai/razrabotka-ii-reshenij", labelRu: "Разработка ИИ-решений", labelEn: "AI solution development", blurbRu: "Под ключ · discovery → production", blurbEn: "Discovery to production" },
      ...
      { href: "/ai/ii-dlya-buhgalterii", labelRu: "ИИ для бухгалтерии", labelEn: "AI for accounting", blurbRu: "Первичка в 1С без ручного ввода", blurbEn: "Primary docs into 1C" },
      { href: "/ai/ii-dlya-hr", labelRu: "ИИ для HR", labelEn: "AI for HR", blurbRu: "Скрининг, адаптация, регламенты", blurbEn: "Screening, onboarding, policies" },
      { href: "/ai/ii-dlya-marketinga", labelRu: "ИИ для маркетинга", labelEn: "AI for marketing", blurbRu: "Квалификация лидов, контент, отчёты", blurbEn: "Leads, content, reports" },
      { href: "/ai/ii-dlya-nedvizhimosti", labelRu: "ИИ для недвижимости", labelEn: "AI for real estate", blurbRu: "Ответ на заявку за минуту", blurbEn: "Reply within a minute" },
      { href: "/ai/ii-dlya-internet-magazina", labelRu: "ИИ для интернет-магазина", labelEn: "AI for e-commerce", blurbRu: "Консультант, поддержка, карточки", blurbEn: "Consultant, support, cards" },
      { href: "/ai/ii-dlya-stroitelstva", labelRu: "ИИ для строительства", labelEn: "AI for construction", blurbRu: "Сметы, КС-2, тендеры", blurbEn: "Estimates, KS-2, tenders" },
      { href: "/ai/ii-dlya-proizvodstva", labelRu: "ИИ для производства", labelEn: "AI for manufacturing", blurbRu: "КП по спецификациям, ОТК, база знаний", blurbEn: "Quotes, QC, knowledge base" },
      { href: "/ai/ii-dlya-logistiki", labelRu: "ИИ для логистики", labelEn: "AI for logistics", blurbRu: "Заявки в TMS, статусы, документы", blurbEn: "Requests into TMS" },
      { href: "/ai/ii-dlya-kliniki", labelRu: "ИИ для клиники", labelEn: "AI for clinics", blurbRu: "Запись 24/7, напоминания", blurbEn: "24/7 booking" },
      { href: "/ai/ii-assistent-dlya-rukovoditelya", labelRu: "ИИ-ассистент руководителя", labelEn: "AI assistant for executives", blurbRu: "Сводка, протоколы, ответы по данным", blurbEn: "Digest, minutes, data answers" },
