...
export const CATALOG_LANDING_SPECS_BITRIX_SITE_CMS: LandingSpec[] = [
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Настройка 1С-Битрикс: структура, модули, права, формы, каталог. Партнёр 1С-Битрикс. От 150 000 ₽ за согласованный объём.",
      problems: [
      ...
      faq: [
        ...
        {
          q: "Срок и цена?",
          a: "Базовая настройка — от 150 000 ₽. Комплекс (магазин, каталог, CRM) — от 300 000 ₽. Срок 1–4 недели.",
        },
        {
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Рабочий сайт на CMS: разделы, шаблон, формы, мобильная вёрстка. От 150 000 ₽.",
      problems: [
      ...
      faq: [
        ...
        { q: "Цена?", a: "От 150 000 ₽. Посадка макета Figma — отдельная смета." },
      ],
    },
    en: {
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Корпоративный сайт: услуги, заявки, роли, без лишнего магазина. От 150 000 ₽.",
      problems: [
      ...
      faq: [
        ...
        { q: "Цена?", a: "От 150 000 ₽. Связка с Битрикс24 — плюсом, см. /integrations/bitrix24-s-sajtom." },
      ],
    },
    en: {
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Ядро стоит, сайта нет: права, модули, шаблон, первый контент. От 150 000 ₽.",
      problems: [
      ...
      faq: [
        ...
        { q: "Цена?", a: "От 150 000 ₽, если ядро живое. Кривой хостинг — отдельная оценка." },
      ],
    },
    en: {
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Сайт + каталог + формы + базовая CRM-связка. Один контур, смета до старта. От 150 000 ₽.",
      problems: [
  ...
  page({
    ...
    ru: {
      ...
      subtitle:
        "Типы, свойства, разделы, привязки к шаблону и фильтру. От 150 000 ₽.",
      problems: [
      ...
      faq: [
        ...
        { q: "Цена?", a: "От 150 000 ₽ за согласованный набор инфоблоков." },
      ],
    },
    en: {
