...
export const CATALOG_LANDING_SPECS_INTENT: LandingSpec[] = [
  ...
  },
  {
    ...
    ru: {
      ...
      intro: [
        "Формулировка из Wordstat — коммерческая: автоматизация бизнеса с помощью ИИ, не «что такое нейросеть».",
  ...
  },
  {
    ...
    ru: {
      ...
      intro: [
        "«Автоматизация CRM» (Wordstat ~650) — отдельный коммерческий запрос, не общая «автоматизация бизнеса».",
  ...
  },
  {
    ...
    ru: {
      ...
      intro: [
        "Wordstat: «корпоративная нейросеть» (~240) и «корпоративный ИИ-ассистент» (~110) — B2B-запросы на приватный контур.",
