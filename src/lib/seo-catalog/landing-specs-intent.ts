...
export const CATALOG_LANDING_SPECS_INTENT: LandingSpec[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "компания по автоматизации бизнеса",
      "компании по автоматизации бизнеса",
    ...
    ru: {
      h1: "Компания по автоматизации бизнеса",
      subtitle:
        "Компания по автоматизации бизнеса и бизнес-процессов: CRM, документы, заявки без ручного копирования. Фиксированная смета и ROI до старта.",
      problems: [
      ...
      intro: [
        "В поиске «компания по автоматизации бизнеса» ищут подрядчика с сметой — не курс по Python.",
  ...
  },
  {
    ...
    keywords: [
      ...
      "ии для бизнеса под ключ",
      "ии автоматизация бизнеса под ключ",
      "ai автоматизация",
    ],
    related: [
      { href: "/ai/ai-implementation", labelRu: "Внедрение ИИ", labelEn: "AI implementation" },
  ...
  },
  {
    ...
    related: [
      ...
      { href: "/integrations/bitrix24-implementation", labelRu: "Внедрение Битрикс24", labelEn: "Bitrix24 implementation" },
    ...
    ru: {
      h1: "Автоматизация и внедрение CRM",
      subtitle:
        "Внедрение CRM и автоматизация процессов: стадии, роботы, заявки с сайта, отчёты. Пилот от 300 000 ₽, 2–4 недели.",
      problems: [
        "CRM заполняют «когда вспомнят» — дисциплина данных размыта",
        "Заявки теряются между сайтом и менеджером",
        "Нет роботов, эскалаций и SLA по этапам",
        "Руководитель не видит воронку в реальном времени",
      ],
      deliverables: [
        "Воронка, поля, права и роли",
        "Роботы и интеграции источников лидов",
        "Дашборды и контроль дисциплины",
        "Обучение отдела продаж + смета полного контура",
      ],
      intro: [
      ...
      faq: [
        {
          ...
          a: "Пилот одного сценария — от 300 000 ₽ (2–4 недели). Полный контур с интеграциями — обычно от 500 000 ₽. Смета фиксируется до старта.",
        },
        {
