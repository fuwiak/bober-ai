...
export const SPECIALIST_ARTICLE_SPECS: IntentArticleSpec[] = [
  {
    ...
    related: [
      ...
      { href: "/services/sales-ai-agent", labelRu: "ИИ-агент для продаж", labelEn: "Sales AI agent" },
      { href: "/blog/ai-agents-in-sales-architecture", labelRu: "Архитектура ИИ-агента в продажах", labelEn: "Sales AI agent architecture" },
    ...
    ru: {
      ...
      h1: "AI CRM Automation: промышленная архитектура без отдельного ИИ-интерфейса",
      sections: [
        {
      ...
      checklist: {
        title: "Чек-лист перед запуском ИИ в CRM",
        items: [
  ...
  "additionalProperties": false
      ...
      faq: [
        ...
        },
        {
          ...
          a: "С одной частой и измеримой задачи: сводки разговора, классификации лида или черновика дожима с записью результата в существующий интерфейс CRM.",
        },
      ],
    },
    en: {
  ...
  },
  {
    ...
    related: [
      ...
      { href: "/blog/ai-agents-in-sales-architecture", labelRu: "ИИ-агенты в продажах", labelEn: "AI agents in sales" },
    ],
    publishedAt: "2026-07-25",
    ru: {
      title: "MCP vs API: что выбрать для ИИ-агента и корпоративной интеграции",
      description:
  ...
  },
  {
    ...
    related: [
      ...
      { href: "/services/enterprise-ai-assistant", labelRu: "Корпоративный ИИ-ассистент", labelEn: "Enterprise AI assistant" },
    ...
    ru: {
      ...
      checklist: {
        title: "Чек-лист перед выводом RAG в промышленную эксплуатацию",
        items: [
  ...
  },
  {
    ...
    cluster: "specialist-ai-architecture",
    keywords: ["AI agents in sales", "AI sales agent architecture", "агент ИИ для продаж", "AI агент CRM", "sales automation AI"],
    related: [
      { href: "/services/sales-ai-agent", labelRu: "ИИ-агент для продаж", labelEn: "Sales AI agent" },
      { href: "/services/crm-integration", labelRu: "Интеграция CRM", labelEn: "CRM integration" },
      { href: "/blog/ai-crm-automation-architecture", labelRu: "AI CRM Automation", labelEn: "AI CRM Automation" },
    ...
    ru: {
      ...
      sections: [
        {
          title: "ИИ-агент — не автономный продавец",
          paragraphs: [
            "В production ИИ-агент для продаж — это управляемый workflow с моделью в отдельных шагах. Он получает событие из CRM, собирает контекст, выбирает разрешённый инструмент, готовит результат и останавливается перед действием, которое требует решения человека. Цель — сократить рутину вокруг переговоров, а не скрыть весь процесс внутри LLM.",
            "Полезные сценарии: квалификация входящего лида, сводка звонка, заполнение карточки, поиск фактов о продукте, черновик дожим и сигнал о зависшей сделке. Переговоры о цене, обязательства перед клиентом и нестандартные условия остаются у менеджера.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Не оценивайте агента числом сгенерированных сообщений. Измеряйте время до первого ответа, подготовку дожим, полноту CRM, число сделок без следующего шага, acceptance rate черновиков и конверсию этапов. Высокий acceptance rate без влияния на процесс может означать только более гладкий текст.",
      ...
      checklist: {
        title: "Чек-лист безопасного ИИ-агента в продажах",
        items: [
...
},
{
  ...
  "annotations": { "mutating": true, "requiresApproval": true, "maxPerDealPerDay": 3 }
      ...
      faq: [
        { q: "Может ли ИИ-агент сам писать клиентам?", a: "Технически да, но начинать лучше с черновиков и подтверждения. Автоматическую отправку ограничивают проверенными сценариями низкого риска." },
...
},
{
  ...
  },
  {
    ...
    related: [
      ...
      { href: "/blog/rag-architecture-production", labelRu: "Production-архитектура RAG", labelEn: "Production RAG architecture" },
      { href: "/blog/mcp-vs-api", labelRu: "MCP vs API", labelEn: "MCP vs API" },
      { href: "/blog/ai-for-manufacturing", labelRu: "ИИ для производства", labelEn: "AI for manufacturing" },
    ],
    publishedAt: "2026-07-25",
    ru: {
      ...
      h1: "AI Document Processing: промышленный пайплайн от файла до данных в ERP",
      sections: [
        {
      ...
      faq: [
        { q: "Может ли LLM заменить OCR?", a: "Не в каждом pipeline. Мультимодальные модели помогают со сложными макетами, но промышленный IDP всё равно нужны координаты, confidence, валидация и воспроизводимое чтение." },
  ...
  },
  {
    ...
    keywords: [
      ...
      "AI на производстве",
      "автоматизация производства с ИИ",
      "MES AI integration",
    ],
    related: [
    ...
    publishedAt: "2026-07-25",
    ru: {
      title: "ИИ для производства: где автоматизация с ИИ реально даёт эффект",
      description:
      ...
      h1: "ИИ для производства: архитектура и сценарии с измеримым ROI",
      sections: [
        {
      ...
      faq: [
        {
          ...
          a: "Нет. ИИ-слой работает поверх них как помощник для неструктурированных данных — фото, текста, документов. Контроль оборудования и безопасность остаются в детерминированных системах.",
        },
        {
          q: "Можно ли развернуть решение в закрытом контуре предприятия?",
          a: "Да. Для чувствительных производственных данных предусмотрен on-premise или изолированный облачный контур с теми же контрактами валидации, что и в облачной версии.",
        },
        {
  ...
  },
  {
    ...
    keywords: [
      ...
      "генерация коммерческих предложений с ИИ",
