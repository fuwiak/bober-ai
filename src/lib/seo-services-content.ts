...
const CONTENT_RU: Record<string, SeoServiceContent> = {
  ...
  "ai-consulting": {
    ...
    deliverables: [
      ...
      "Дорожная карта внедрения (см. AI Discovery)",
    ],
    intro: [
      ...
      "Форматы: однодневная сессия с руководством, двухнедельный discovery (AI Discovery), разбор существующего пилота, усиление внутренней команды.",
    ...
    faqTitle: "Частые вопросы",
    faq: [
      { q: "Чем консалтинг отличается от discovery?", a: "Discovery — фиксированный документ с ROI. Консалтинг шире: советы, воркшопы, разбор архитектуры." },
      { q: "Обязательно ли потом внедрять у вас?", a: "Нет. Дорожная карта остаётся вашей. Внедрение — по желанию." },
      { q: "В каких отраслях опыт?", a: "IT, кибербезопасность, продажи в производстве, professional services." },
