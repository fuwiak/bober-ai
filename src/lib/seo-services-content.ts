...
const CONTENT_RU: Record<string, SeoServiceContent> = {
  ...
  "voice-ai": {
    ...
    metaDescription:
      "Речевая аналитика звонков: транскрипты, качество разговоров, факты в CRM и контроль менеджеров. STT/TTS, Bitrix24/amoCRM. От 500 000 ₽.",
    eyebrow: "Услуга · Речевая аналитика",
    h1: "Речевая аналитика звонков для отдела продаж",
    subtitle:
      "Разбор всех звонков, а не выборочная прослушка: качество, возражения, факты в CRM и задачи менеджеру.",
