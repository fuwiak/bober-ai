...
const CONTENT_RU: Record<string, SeoServiceContent> = {
  ...
  "ai-sales-loop": {
    ...
    metaDescription:
      "ИИ для отдела продаж: анализ звонков, автозаполнение CRM, задачи и follow-up, контроль менеджеров. Bitrix24/amoCRM. От 500 000 ₽.",
  ...
  "voice-ai": {
    ...
    deliverables: [
      ...
      "Скоринг, саммари, факты и follow-up task в карточке",
