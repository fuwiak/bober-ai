...
export const YANDEX_IMPORTANT_PATHS = [
  ...
  "/ai/kompanii-po-vnedreniyu-ii-moskva",
  "/ai/kira-llm-kaspersky-ai-assistent",
  "/solutions/rag-sistema-dlya-biznesa",
  "/integrations/vnedrenie-roistat-otdel-prodazh-cena",
  "/solutions/crm-sistema-bober",
  "/ai/ii-dlya-yuristov",
  "/ai/ii-dlya-buhgalterii",
  "/ai/ii-dlya-hr",
  "/ai/ii-dlya-marketinga",
  "/ai/razrabotka-ii-reshenij",
  "/ai/razrabotka-ai-agentov",
  "/ai/gpt-dlya-biznesa",
  "/ai/ii-pomoshchnik-na-qwen",
  "/ai/ii-kontrol-dogovornyh-obyazatelstv",
  "/solutions/ii-bot-dlya-biznesa",
  "/solutions/it-konsalting",
  "/solutions/cifrovizaciya-biznesa",
  "/automation/avtomatizaciya-sklada",
  "/integrations/integraciya-1s-s-sajtom",
  ...
  "/amocrm/sales",
  "/integrations/1c",
  "/integrations/telephony-ai",
  "/integrations/telephony-crm",
  "/integrations/business-from-phone",
  ...
  "/ai/private-llm",
  "/ai/vnedrenie-iskusstvennogo-intellekta-v-biznes",
  "/ai/stoimost-vnedreniya-ii",
