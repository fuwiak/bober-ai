...
const RULES: ReplyRule[] = [
  {
    test: /начать|с чего|discovery|аудит|разбор|process.?review/i,
    reply:
      "Быстрый вход: бесплатный разбор одного процесса или AI-аудит за 5 минут. После брифа — план и вилка бюджета в течение 24 часов.",
  },
  {
    test: /crm|bitrix|amo|воронк|лид|продаж/i,
    reply:
      "Внедряем и связываем Bitrix24 / amoCRM с документами, 1С, телефонией и ИИ-слоем: follow-up, скоринг, контроль воронки. Пилот — на одном процессе.",
  },
  {
